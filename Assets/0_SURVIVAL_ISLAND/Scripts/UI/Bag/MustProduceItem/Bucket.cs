...
public class Bucket : MustProduceItem
{
    private void Awake()
    {
    ...
    // }
    //
    public Bucket(Define.TypeItem type, int numOwned, int numGenerate, Sprite icon) : base(type, numOwned, numGenerate, icon)
    {
    }

    public Bucket(Define.TypeItem type, int numGenerate, Sprite icon) : base(type, numGenerate, icon)
    {
    }
}
